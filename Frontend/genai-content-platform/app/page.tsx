...
import OutputWorkspace
  from "@/components/OutputWorkspace";
    ...
    async () => {
      ...
      try {
        ...
        /*
         ...
         Your current backend accepts sourceText.

         Therefore if a file is selected but no text
         is entered, we currently send its filename.

         Real PDF/DOCX extraction requires an UploadFile
         endpoint, which can be added separately.
        */
