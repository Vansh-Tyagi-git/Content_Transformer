  ...
  const outputOptions = [
    {
      ...
      label: "Summary",
      icon: FileText,
      desc: "Concise executive synthesis & key takeaways",
    },
    {
      id: "advisory",
      label: "Advisory",
      icon: ShieldAlert,
      desc: "Structured threat assessment & policy brief",
    },
    {
      id: "linkedin",
      label: "LinkedIn Post",
      icon: LinkedInIcon,
      desc: "Professional long-form post & hashtags",
    },
    {
      id: "twitter",
      label: "Twitter/X Post",
      icon: TwitterIcon,
      desc: "Engaging thread & concise social updates",
    },
    {
      id: "presentation",
      label: "Presentation",
      icon: PresentationIcon,
      desc: "Slide structure, bullets & speaker notes",
    },
    {
      id: "infographic",
      label: "Infographic",
      icon: PieChart,
      desc: "Visual data breakdown & infographic layout",
    },
    {
      id: "video",
      label: "Video Script",
      icon: Video,
      desc: "Scene-by-scene storyboard & voiceover script",
    },
  ];
      ...
      <section className="relative overflow-hidden min-h-[420px] bg-[#070d1a] text-white flex flex-col justify-center px-6 lg:px-16 py-16 border-b border-slate-800">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          >
            ...
            {/* Flow Pathways */}
            <path
              d="M 240 290 C 500 290, 680 500, 960 500"
              fill="none"
              stroke="url(#flowCyan)"
              strokeWidth="1.5"
            />
            ...
            <path
              d="M 220 570 C 480 570, 680 540, 960 540"
              fill="none"
            ...
            <path
              d="M 960 500 C 1240 500, 1420 270, 1680 270"
              fill="none"
              stroke="url(#flowCyan)"
              strokeWidth="1.5"
            />
            ...
            <path
              d="M 960 540 C 1240 540, 1420 750, 1660 750"
              fill="none"
              stroke="url(#flowPurple)"
              strokeWidth="1.5"
            />
            ...
            <g transform="translate(960, 520)">
              ...
              <polygon
                points="0,-60 45,-45 60,0 45,45 0,60 -45,45 -60,0 -45,-45"
                fill="#0f172a"
                stroke="#38bdf8"
                strokeWidth="1"
                opacity="0.8"
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-8 text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 max-w-sm mt-1">
                    Select any output format on the left
                    and click Generate to view the rendered
                    deliverable asset.
                  </p>
                </div>
              </div>
